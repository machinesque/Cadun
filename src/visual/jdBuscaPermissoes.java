 ...
 *
 * Created on 09/08/2010, 14:49:01
 */
package visual;
...
public class jdBuscaPermissoes extends javax.swing.JDialog {
    ...
    public jdBuscaPermissoes(java.awt.Frame parent, boolean modal) {
        super(parent, "Buscar Permissões - " + versao.getVersao() + " - " + versao.getAno(), modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jtbBuscaUsuario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome do Usuário", "Código Permissões"
            }
        ));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(jcbBuscaNomeUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 456, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//Outros Metodos ===========================================================================================================================================
    ...
    public void pesquisar() {
        ...
        for (int i = 0; i < listaUsuario.size(); i++) {
            ...
            modelo.addRow(new String[]{String.valueOf(permiss.getNomeUsuario()), String.valueOf(permiss.getCodigoPermissoes())});
        ...
        if (jtbBuscaUsuario.getRowCount() > 0) {
            ...
            classeGeral.msgInforma("Não há permissões com estes dados!");
        }
    ...
    public void buscaDados() {
        ...
        codigoPermiss = Integer.valueOf((String) jtbBuscaUsuario.getValueAt(jtbBuscaUsuario.getSelectedRow(), 1));
