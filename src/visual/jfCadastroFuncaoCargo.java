 ...
 * @author luizam
 */
public class jfCadastroFuncaoCargo extends javax.swing.JFrame {
    ...
    private jdBuscaFuncaoCargo jdbfc;
    ...
    public jfCadastroFuncaoCargo() {
        super("Cadastro Função/Cargo - " + versao.getVersao() + " - " + versao.getAno());
        initComponents();
    ...
    private void initComponents() {
        ...
        jtfNomeFuncaoCargo = new javax.swing.JTextField();
        ...
        jLabel1.setText("Nome da Funão / Cargo: ");

        jtfNomeFuncaoCargo.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jtfNomeFuncaoCargo.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jtfNomeFuncaoCargo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jtfNomeFuncaoCargoFocusLost(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jtfNomeFuncaoCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 390, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jtfNomeFuncaoCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        if (!jtfNomeFuncaoCargo.getText().isEmpty()) {

            verificaCadastroFuncaoCargo();

            if (opcao.equals("salvar")) {

                if (!funcaoCargoVerificado.isEmpty()) {
                    iniciaClasseGeral();
                    classeGeral.msgAtencao("Essa Função/Cargo já existe!");
                } else {
                    salvar();
                    opcao = "salvar";
                }
            ...
            iniciaClasseGeral();
            classeGeral.msgAtencao("Complete o Campo com o Nome da Função/Cargo!");
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        ...
        if (jdbfc == null) {
            jdbfc = new jdBuscaFuncaoCargo(null, true);
        }

        jdbfc.setVisible(true);

        setFuncaoCargoBuscado(jdbfc.getFuncaoCargo());
        jdbfc.setFuncaoCargo();
    ...
    private void jtfNomeFuncaoCargoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfNomeFuncaoCargoFocusLost
        jtfNomeFuncaoCargo.setText(jtfNomeFuncaoCargo.getText().toUpperCase());
    }//GEN-LAST:event_jtfNomeFuncaoCargoFocusLost
    /**
    ...
    private javax.swing.JTextField jtfNomeFuncaoCargo;
...
//Outros Metodos ===========================================================================================================================================
    ...
    public void abilitaCampos() {
        ...
        jtfNomeFuncaoCargo.setEditable(true);
...
//Geradores, Validadores===========================================================================================================================================
    ...
    public void verificaCadastroFuncaoCargo() {

        iniciaDao();
        //DAO dao = new DAO();

        funcaoCargoVerificado = dao.verificarCadastroFuncaoCargo(jtfNomeFuncaoCargo.getText());

    }

//Getters and Setters===========================================================================================================================================
    public void setFuncaoCargoBuscado(FuncaoCargo funcaoCargoBuscado) {

        if (funcaoCargoBuscado.getNomeFuncaoCargo().isEmpty()) {
        } else {
            ...
            jtfNomeFuncaoCargo.setText(funcaoCargoBuscado.getNomeFuncaoCargo());

            codigoAux = funcaoCargoBuscado.getCodigoFuncaoCargo();
            codigo = funcaoCargoBuscado.getCodigoFuncaoCargo();
            funcaoCargo.setCodigoFuncaoCargo(codigoAux);

            jtfNomeFuncaoCargo.setEditable(false);
    ...
    public void setNumeroCaracteres() {
        ...
        jtfNomeFuncaoCargo.setDocument(new FixedLengthDocument(60));
    ...
    public void getPermissoes() {
        ...
        cadastrarFuncaoCargo = permissoes.isCadastrarFuncaoCargo();
...
//Metodos DAO===================================================================================================================================================
    public void salvar() {
        ...
        if (!jtfNomeFuncaoCargo.getText().isEmpty()) {
            ...
            funcaoCargo.setNomeFuncaoCargo(jtfNomeFuncaoCargo.getText());

            dao.inserir(funcaoCargo, 7);
            cancelar();
    ...
    public void excluir() {
        ...
        if (classeGeral.msgConfirma("Deseja excluir esta Função/Cargo?")) {

            iniciaDao();
            iniciaFuncaoCargo();
            //DAO dao = new DAO();
            dao.excluir(funcaoCargo, 7);
            cancelar();
        }
