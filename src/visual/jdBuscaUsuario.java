 ...
 *
 * Created on 09/08/2010, 14:51:34
 */
package visual;
...
public class jdBuscaUsuario extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jtbBuscaUsuario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome do Usuário", "Matricula", "Código"
            }
        ));
        ...
        jtfBuscaMatriculaUsuario.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jtfBuscaMatriculaUsuarioFocusLost(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtfBuscaMatriculaUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jcbBuscaNomeUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 474, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void jtfBuscaMatriculaUsuarioFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfBuscaMatriculaUsuarioFocusLost
        ClasseGeral cg = new ClasseGeral();

        jtfBuscaMatriculaUsuario.setText(jtfBuscaMatriculaUsuario.getText().toUpperCase());

        if (cg.StringToInt(jtfBuscaMatriculaUsuario.getText()) == 9999999) {
    ...
    }//GEN-LAST:event_jtfBuscaMatriculaUsuarioFocusLost
    /**
...
//Outros Metodos ===========================================================================================================================================
    ...
    public void pesquisar() {
        ...
        if (!tipoCadastroUsuario.equals("GERAL")) {
            nomeEntidade = tipoCadastroUsuario;
        } else {
            nomeEntidade = "";
        }

        listaUsuario = (List) dao.listarUsuarios(nomeUser, jtfBuscaMatriculaUsuario.getText(), nomeEntidade);
        ...
        for (int i = 0; i < listaUsuario.size(); i++) {
            ...
            modelo.addRow(new String[]{String.valueOf(user.getNomeUsuario()), String.valueOf(user.getMatricula()), String.valueOf(user.getCodigoUsuario())});
        ...
        if (jtbBuscaUsuario.getRowCount() > 0) {
            ...
            classeGeral.msgInforma("Não há usuário com estes dados!");
        }
    ...
    public void buscaDados() {
        ...
        codigoUser = Integer.parseInt((String) jtbBuscaUsuario.getValueAt(jtbBuscaUsuario.getSelectedRow(), 2));
        nomeUser = (String) jtbBuscaUsuario.getValueAt(jtbBuscaUsuario.getSelectedRow(), 0);
        matriculaUser = (String) jtbBuscaUsuario.getValueAt(jtbBuscaUsuario.getSelectedRow(), 1);
    ...
    public void preencheComboUsuarios() {
        ...
        listaUsuarios = dao.listarUsuarios("", "", nomeEntidade);
